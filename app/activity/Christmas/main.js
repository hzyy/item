...
$("#btn").click(function() {
	ReportJS.report({
		...
		if (response.success == '1') {
			...
			//window.location.href = 'gamecircle://topic/topicDetail/?id=57846088427175937';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/57846088427175937';
		}
	});
});
