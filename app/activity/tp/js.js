...
$("#btn3").click(function() {
    ReportJS.report({
        ...
        'params': '{"activityId":"335951841815300096"}'
    },function(response){
        if (response.success == '1') {
            window.wxc.xcConfirm("活动已经结束了<br/>请多多关注其他热门活动");
            //if(DeviceJS.loginUser.device.deviceType == "ios"){
            //    window.location.href = 'gamecircle://topic/HotTopicsListMore/?topicId:123';
            //}else{
            //    window.location.href = 'app://activity/ActivityOperateAction?class=com.ymcx.gamecircle.activity.TopicActivity';
            //}
        }
