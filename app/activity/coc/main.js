...
$("#btn").click(function() {
	ReportJS.report({
		...
		if (response.success == '1') {
			...
			//window.location.href = 'gamecircle://topic/topicDetail/?id=45286547486670849';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/45286547486670849';
		}
	});
});