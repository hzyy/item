...
$(".btn").click(function() {
	ReportJS.report({
		...
		'params': '{"activityId":"77061415621951489"}'
	},function(response){
		if (response.success == '1') {
			window.wxc.xcConfirm("活动已经结束了<br/>请多多关注其他热门活动");
			//window.location.href = 'gamecircle://topic/topicDetail/?id=73101902461730817';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/73101902461730817';
		}
	});
});