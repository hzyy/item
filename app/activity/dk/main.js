...
$("#btn").click(function() {
	ReportJS.report({
		...
		'Version': DeviceJS.loginUser.device.Version,
		'params': '{"activityId":"282658180055071744"}'
	},function(response){
		if (response.success == '1') {
			window.wxc.xcConfirm("活动已经结束了<br/>请多多关注其他热门活动");
			//window.location.href = 'gamecircle://topic/topicDetail/?id=282648079583997952';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/282648079583997952';
		}
	});
});
