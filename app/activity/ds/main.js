$("#btn").click(function() {
	ReportJS.report({
		...
		'params': '{"activityId":"469668055124433920"}'
	},function(response){
		if (response.success == '1') {
			//window.location.href = 'gamecircle://topic/topicDetail/?id=469667751826050048';
			window.wxc.xcConfirm("活动已经结束了<br/>请多多关注其他热门活动");
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/469667751826050048';
		}
	});
});