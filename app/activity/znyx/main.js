...
$("#btn").click(function() {
	ReportJS.report({
		...
		if (response.success == '1') {
			...
			//window.location.href = 'gamecircle://topic/topicDetail/?id=231761797291185152';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/231761797291185152';
		}
	});
});