...
$("#btn").click(function() {
    ReportJS.report({
        ...
        if (response.success == '1') {
            ...
            //window.location.href = 'gamecircle://topic/topicDetail/?id=47889933323337729';
        }
        if(!MobileJS.isMobile()){
            window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/47889933323337729';
        }
    });
});