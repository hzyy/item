...
$(".btn").click(function() {
	ReportJS.report({
		...
		'params': '{"activityId":"185421849617424384"}'
	},function(response){
		if (response.success == '1') {
			window.wxc.xcConfirm("活动已经结束了<br/>请多多关注其他热门活动");
			//window.location.href = 'gamecircle://topic/topicDetail/?id=185160277854840832';
		}
		if(!MobileJS.isMobile()){
			window.location.href = 'http://site.youka.youmengchuangxiang.com/topic/185160277854840832';
		}
	});
});
